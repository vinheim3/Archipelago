...
locations: dict[str, tuple[str, None | Rule]] = {
    ...
    l.lava_challenge_climbing_ice: (r.lava_challenge, can_hover),
    l.lava_challenge_miniboss_reward: (r.lava_challenge, And(can_hover, can_shoot)),
    ...
    l.clouds_area_miniboss_reward: (r.clouds, None),
